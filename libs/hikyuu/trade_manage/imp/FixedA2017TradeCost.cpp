...
CostRecord FixedA2017TradeCost::getBuyCost(
        const Datetime& datetime, const Stock& stock,
...
CostRecord FixedA2017TradeCost::getSellCost(
        const Datetime& datetime, const Stock& stock,
        price_t price, size_t num) const {
    CostRecord result;
    if( stock.isNull() ){
...
TradeCostPtr HKU_API TC_FixedA2017(
        price_t commission,
