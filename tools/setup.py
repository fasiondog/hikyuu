...
setup(
        ...
        data_files = [('Lib/site-packages/hikyuu', ['hikyuu/_hikyuu.pyd']),
                      ('Lib/site-packages/hikyuu/indicator', ['hikyuu/indicator/_indicator.pyd']),
                      ('Lib/site-packages/hikyuu/trade_instance', ['hikyuu/trade_instance/_trade_instance.pyd']),
                      ('Lib/site-packages/hikyuu/trade_manage', ['hikyuu/trade_manage/_trade_manage.pyd']),
                      ('Lib/site-packages/hikyuu/trade_sys', ['hikyuu/trade_sys/_trade_sys.pyd']),
                      ('DLLs', ['../bin/hikyuu.dll']),
