...
def KRecordList_to_np(data):
    """转化为numpy结构数组"""
    return krecords_to_np(data)


def KRecordList_to_df(data):
    """转化为pandas的DataFrame"""
    return pd.DataFrame.from_records(krecords_to_np(data))


KRecordList.to_np = KRecordList_to_np
KRecordList.to_df = KRecordList_to_df
