...
function _cp_hikyuu(installdir)
    ...
    if os.host() == "windows" then
        ...
        os.tryrm(installdir .. "/.idea")
        os.tryrm(installdir .. "/.settings")
        ...
        os.tryrm(installdir .. "/lib/libboost_unit_test*")
        os.tryrm(installdir .. "/bin/unit-test")
        os.tryrm(installdir .. "/bin/demo")
