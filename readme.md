...
The C++ core of Hikyuu depends directly on the open-source projects listed in
[THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md), together with their project URLs and licenses
(indirect dependencies are not listed). Thanks to all the open-source authors for their contributions 🙏
