 ...
 * standalone Asio.
 * The conditional compilation macro HKU_USE_BOOST_ASIO controls which implementation is used:
 * - HKU_USE_BOOST_ASIO = 1 (default): Boost.Asio is used
 * - HKU_USE_BOOST_ASIO = 0: the standalone Asio is used
 *
 * @example
 * @code
...
// this_coro is a namespace, not a type
namespace this_coro = boost::asio::this_coro;

// Wrappers of the commonly used functions and objects
