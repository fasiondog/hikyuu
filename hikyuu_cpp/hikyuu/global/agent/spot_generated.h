...
struct Spot FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    bool Verify(::flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_MARKET) &&
               verifier.VerifyString(market()) && VerifyOffset(verifier, VT_CODE) &&
               verifier.VerifyString(code()) && VerifyOffset(verifier, VT_NAME) &&
               verifier.VerifyString(name()) && VerifyOffset(verifier, VT_DATETIME) &&
               ...
               VerifyField<double>(verifier, VT_VOLUME, 8) && VerifyOffset(verifier, VT_BID) &&
               verifier.VerifyVector(bid()) && VerifyOffset(verifier, VT_BID_AMOUNT) &&
               verifier.VerifyVector(bid_amount()) && VerifyOffset(verifier, VT_ASK) &&
               verifier.VerifyVector(ask()) && VerifyOffset(verifier, VT_ASK_AMOUNT) &&
               verifier.VerifyVector(ask_amount()) && verifier.EndTable();
    }
};
...
struct SpotBuilder {
    ...
    explicit SpotBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<Spot> CreateSpot(
  ::flatbuffers::FlatBufferBuilder &_fbb, ::flatbuffers::Offset<::flatbuffers::String> market = 0,
  ::flatbuffers::Offset<::flatbuffers::String> code = 0,
  ::flatbuffers::Offset<::flatbuffers::String> name = 0,
  ::flatbuffers::Offset<::flatbuffers::String> datetime = 0, double yesterday_close = 0.0,
  double open = 0.0, double high = 0.0, double low = 0.0, double close = 0.0, double amount = 0.0,
  double volume = 0.0, ::flatbuffers::Offset<::flatbuffers::Vector<double>> bid = 0,
...
inline ::flatbuffers::Offset<Spot> CreateSpotDirect(
  ::flatbuffers::FlatBufferBuilder &_fbb, const char *market = nullptr, const char *code = nullptr,
  const char *name = nullptr, const char *datetime = nullptr, double yesterday_close = 0.0,
  double open = 0.0, double high = 0.0, double low = 0.0, double close = 0.0, double amount = 0.0,
  double volume = 0.0, const std::vector<double> *bid = nullptr,
  const std::vector<double> *bid_amount = nullptr, const std::vector<double> *ask = nullptr,
  const std::vector<double> *ask_amount = nullptr) {
    ...
    return hikyuu::flat::CreateSpot(_fbb, market__, code__, name__, datetime__, yesterday_close,
                                    open, high, low, close, amount, volume, bid__, bid_amount__,
                                    ask__, ask_amount__);
}

struct SpotList FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    typedef SpotListBuilder Builder;
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_SPOT = 4 };
    const ::flatbuffers::Vector<::flatbuffers::Offset<hikyuu::flat::Spot>> *spot() const {
        return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<hikyuu::flat::Spot>> *>(
          VT_SPOT);
    }
    bool Verify(::flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_SPOT) &&
               verifier.VerifyVector(spot()) && verifier.VerifyVectorOfTables(spot()) &&
               verifier.EndTable();
    }
};
...
struct SpotListBuilder {
    ...
    ::flatbuffers::uoffset_t start_;
    void add_spot(
      ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<hikyuu::flat::Spot>>>
        spot) {
        fbb_.AddOffset(SpotList::VT_SPOT, spot);
    }
    explicit SpotListBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline ::flatbuffers::Offset<SpotList> CreateSpotList(
  ...
  ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<hikyuu::flat::Spot>>> spot =
    0) {
...
inline ::flatbuffers::Offset<SpotList> CreateSpotListDirect(
  ...
  const std::vector<::flatbuffers::Offset<hikyuu::flat::Spot>> *spot = nullptr) {
    ...
    return hikyuu::flat::CreateSpotList(_fbb, spot__);
}
...
inline bool VerifySpotListBuffer(::flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<hikyuu::flat::SpotList>(nullptr);
}

inline bool VerifySizePrefixedSpotListBuffer(::flatbuffers::Verifier &verifier) {
    return verifier.VerifySizePrefixedBuffer<hikyuu::flat::SpotList>(nullptr);
}

inline void FinishSpotListBuffer(::flatbuffers::FlatBufferBuilder &fbb,
                                 ::flatbuffers::Offset<hikyuu::flat::SpotList> root) {
    fbb.Finish(root);
}

inline void FinishSizePrefixedSpotListBuffer(::flatbuffers::FlatBufferBuilder &fbb,
                                             ::flatbuffers::Offset<hikyuu::flat::SpotList> root) {
