...
#include "NormQuantileUniform.h"

#if HKU_SUPPORT_SERIALIZATION
BOOST_CLASS_EXPORT(hku::NormQuantileUniform)
#endif
...
NormQuantileUniform::~NormQuantileUniform() {}

void NormQuantileUniform::_checkParam(const string &name) const {
