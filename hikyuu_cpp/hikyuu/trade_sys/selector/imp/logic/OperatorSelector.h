...
protected:
    SelectorPtr m_se1;
    SelectorPtr m_se2;
    std::unordered_set<SYSPtr> m_se1_set;  // The prototype system instance set of se1
    std::unordered_set<SYSPtr> m_se2_set;  // The prototype system instance set of se2
