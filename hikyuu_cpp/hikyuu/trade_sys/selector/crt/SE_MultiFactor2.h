 ...
 * @param group 降序排列后分组数量
 * @param group_index 分组索引，默认为 0
 * @return SelectorPtr
 * @ingroup Selector
 */
SelectorPtr HKU_API SE_MultiFactor2(const MFPtr& mf, int group = 10, int group_index = 0);
 ...
 * @ingroup Selector
 */
SelectorPtr HKU_API SE_MultiFactor2(const IndicatorList& src_inds, int group = 10,
                                    int group_index = 0, int ic_n = 5, int ic_rolling_n = 120,
