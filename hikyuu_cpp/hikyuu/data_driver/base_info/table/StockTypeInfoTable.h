...
public:
    StockTypeInfoTable()
    : m_id(0), m_type(0), m_precision(0), m_tick(0.0),
      m_tickValue(0.0), m_minTradeNumber(0), m_maxTradeNumber(0) {}
...
public:
    ...
    void update(const SQLStatementPtr& st) const {
        st->bind(0, m_type, m_precision, m_tick, m_tickValue, 
                 m_minTradeNumber, m_maxTradeNumber, m_description, m_id);
    }
