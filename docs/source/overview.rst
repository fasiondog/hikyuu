...
👉 项目首页：`<https://hikyuu.org/>`_

👉 帮助文档：`<https://hikyuu.readthedocs.io/zh-cn/latest/index.html>`_

👉 Wiki文档（AI生成）: `<https://github.com/fasiondog/hikyuu/wiki>`_

👉 入门示例:  `<https://nbviewer.org/github/fasiondog/hikyuu/blob/master/hikyuu/examples/notebook/000-Index.ipynb?flush_cache=True>`_

👉 策略部件库：`<https://gitee.com/fasiondog/hikyuu_hub>`_  
