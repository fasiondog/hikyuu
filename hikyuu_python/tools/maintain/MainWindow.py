...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1038, 598)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 1041, 601))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(530, 90, 491, 241))
        ...
        self.sh_min_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sh_min_progressBar.setProperty("value", 0)
        self.sh_min_progressBar.setObjectName("sh_min_progressBar")
        self.gridLayout.addWidget(self.sh_min_progressBar, 2, 1, 1, 1)
        self.label_12 = QtWidgets.QLabel(self.layoutWidget4)
        self.label_12.setObjectName("label_12")
        self.gridLayout.addWidget(self.label_12, 2, 0, 1, 1)
        self.sz_day_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sz_day_progressBar.setProperty("value", 0)
        self.sz_day_progressBar.setObjectName("sz_day_progressBar")
        self.gridLayout.addWidget(self.sz_day_progressBar, 1, 1, 1, 1)
        self.sh_day_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sh_day_progressBar.setProperty("value", 0)
        self.sh_day_progressBar.setObjectName("sh_day_progressBar")
        self.gridLayout.addWidget(self.sh_day_progressBar, 0, 1, 1, 1)
        ...
        self.sz_min_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sz_min_progressBar.setProperty("value", 0)
        self.sz_min_progressBar.setObjectName("sz_min_progressBar")
        self.gridLayout.addWidget(self.sz_min_progressBar, 3, 1, 1, 1)
        self.sh_5min_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sh_5min_progressBar.setProperty("value", 0)
        self.sh_5min_progressBar.setObjectName("sh_5min_progressBar")
        self.gridLayout.addWidget(self.sh_5min_progressBar, 4, 1, 1, 1)
        self.sz_5min_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.sz_5min_progressBar.setProperty("value", 0)
        self.sz_5min_progressBar.setObjectName("sz_5min_progressBar")
        self.gridLayout.addWidget(self.sz_5min_progressBar, 5, 1, 1, 1)
