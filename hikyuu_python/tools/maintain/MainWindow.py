...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 20, 501, 126))
        ...
        self.hdf5_day_extern_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.hdf5_day_extern_progressBar.setProperty("value", 0)
        self.hdf5_day_extern_progressBar.setObjectName("hdf5_day_extern_progressBar")
        self.gridLayout.addWidget(self.hdf5_day_extern_progressBar, 3, 1, 1, 1)
        self.hdf5_min_extern_progressBar = QtWidgets.QProgressBar(self.layoutWidget4)
        self.hdf5_min_extern_progressBar.setProperty("value", 0)
        self.hdf5_min_extern_progressBar.setObjectName("hdf5_min_extern_progressBar")
        self.gridLayout.addWidget(self.hdf5_min_extern_progressBar, 4, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setText(_translate("MainWindow", "生成分钟线扩展："))
        self.label_14.setText(_translate("MainWindow", "导入1分钟线："))
        self.label_8.setText(_translate("MainWindow", "导入日线："))
        self.label_16.setText(_translate("MainWindow", "生成日线扩展："))
