...
target("core")
    ...
    add_files("./trade_manage/trade_manage_main.cpp")
    add_files("./trade_manage/_BorrowRecord.cpp")
    add_files("./trade_manage/_CostRecord.cpp")
    add_files("./trade_manage/_FundsRecord.cpp")
    add_files("./trade_manage/_LoanRecord.cpp")
    add_files("./trade_manage/_TradeRecord.cpp")
    add_files("./trade_manage/_PositionRecord.cpp")
    add_files("./trade_manage/_build_in.cpp")
    add_files("./trade_manage/_Performance.cpp")
    add_files("./trade_manage/_OrderBroker.cpp")
