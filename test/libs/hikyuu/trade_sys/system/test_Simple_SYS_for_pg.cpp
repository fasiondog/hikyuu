...
BOOST_AUTO_TEST_CASE( test_SYS_Simple_for_pg) {
    ...
    BOOST_CHECK(std::fabs(tr_list[1].goalPrice - 26.45*1.01) < 0.00001);
    ...
    BOOST_CHECK(std::fabs(tr_list[3].goalPrice - 25.28*1.01) < 0.00001);
    ...
    BOOST_CHECK(tr_list[4].datetime == Datetime(200001060000LL));
    ...
    BOOST_CHECK(tr_list[4].from == PART_PROFITGOAL);
    ...
    BOOST_CHECK(std::fabs(tr_list[1].goalPrice - 26.50*1.01) < 0.00001);
    BOOST_CHECK(tr_list[1].number == 100);
    BOOST_CHECK(std::fabs(tr_list[1].cost.total - 0) < 0.00001);
    ...
    BOOST_CHECK(std::fabs(tr_list[3].goalPrice - 25.18*1.01) < 0.00001);
    BOOST_CHECK(tr_list[3].number == 100);
    BOOST_CHECK(std::fabs(tr_list[3].cost.total - 0) < 0.00001);
    ...
    BOOST_CHECK(tr_list[4].stock == stk);
    BOOST_CHECK(tr_list[4].datetime == Datetime(200001070000LL));
    BOOST_CHECK(tr_list[4].business == BUSINESS_SELL);
